...
import sys
sys.path.append('C:/Users/bao/Desktop/visualkeras')
...
# conv2 = Conv2D(32, 3, activation = 'relu', padding = 'same', strides=2, kernel_initializer = 'he_normal')(conv11)
# conv2 = Conv2D(32, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv2)
# conv2 = Conv2D(32, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv2)

# conv3 = Conv2D(16, 3, activation = 'relu', padding = 'same', strides=2, kernel_initializer = 'he_normal')(conv2)
# conv3 = Conv2D(16, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv3)
# conv3 = Conv2D(16, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv3)

# up8 = Conv2D(32, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(UpSampling2D(size = (2,2))(conv3))
...
# conv10 = Conv2D(64, 1, activation = 'sigmoid')(conv9)

# model = Model(inputs = inputs, outputs = conv10)

# layered_view(model, min_z=20, scale_z=4, to_file='../figures/3Dunet.png')
...
shape_li = [64, 64, 64, 32, 32, 32, 16, 16, 16, 32, 32, 32, 64, 64, 64]
layer_type_li = ['conv64', 'conv64', 'conv64', 'conv32', 'conv32', 'conv32', 'conv16', 'conv16','conv16', 'conv32', 'conv32', 'conv32', 'conv64', 'conv64', 'conv64']
for index in range(len(shape_li)):
    ...
    shape = (shape_li[index], shape_li[index], shape_li[index]) # drop batch size
    layer_type = layer_type_li[index]
    if len(shape) == 1:
        if one_dim_orientation in ['x', 'y', 'z']:
            shape = (1, ) * "xyz".index(one_dim_orientation) + shape
        else:
